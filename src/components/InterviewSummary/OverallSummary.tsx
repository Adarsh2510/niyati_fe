    ...
    <div className="grid md:grid-cols-3 gap-6">
      ...
      <div className="md:col-span-1">
        <Card className="p-6 flex flex-col items-center justify-center">
          ...
          <p className="mt-4 text-lg font-semibold text-center">{scoreData(score).message}</p>
          <p className="text-sm text-gray-500 text-center">{scoreData(score).subMessage}</p>
        </Card>
      </div>
    </div>
  );
